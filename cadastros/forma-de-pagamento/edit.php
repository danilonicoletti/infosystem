...
$consulta = $pdo->query("SELECT * FROM forma_de_pagamento WHERE id_pagamento = " . $id);
    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class="container">
            ...
            <div class="card card-custom">
                <div class="card-body">
                    <div class="" id="forma_de_pagamento_edit" data-wizard-state="step-first" data-wizard-clickable="true">

                        <!--begin::Wizard Body-->
                        <div class="row justify-content-center">
                            <div class="col-12">
                                <!--begin::Form Wizard-->
                                <form class="form" id="forma_de_pagamento_edit_form">
                                    <input name="id" type="hidden" value="<?= $id ?>" />
                                    <input name="type" type="hidden" value="forma_de_pagamento_edit" />
...
<script src="<?= $url ?>assets/js/cadastros/forma-de-pagamento/edit.js"></script>