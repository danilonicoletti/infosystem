...
$consulta = $pdo->query("SELECT codigo FROM forma_de_pagamento ORDER BY codigo DESC LIMIT 0,1");
...
<div class="subheader py-2 py-lg-6" id="kt_subheader">
    <div class="w-100 d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-baseline flex-wrap mr-5">
                ...
                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                    <li class="breadcrumb-item text-muted">
                        <a href="<?= $url ?>forma-de-pagamento" class="text-muted">Forma de Pagamento</a>
                    </li>
                    <li class="breadcrumb-item text-muted">
        ...
        <div class="d-flex align-items-center">
            <!--begin::Button-->
            <a href="../forma-de-pagamento/" class="btn btn-default font-weight-bold">Voltar</a>
            <!--end::Button-->
            <!--begin::Daterange-->
    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class="container">
            ...
            <div class="card card-custom">
                <div class="card-body">
                    <div class="" id="forma_de_pagamento_add" data-wizard-state="step-first" data-wizard-clickable="true">

                        <!--begin::Wizard Body-->
                        <div class="row justify-content-center">
                            <div class="col-12">
                                <!--begin::Form Wizard-->
                                <form class="form" id="forma_de_pagamento_add_form">
                                    <input name="type" type="hidden" value="forma_de_pagamento_add" />
...
<script src="<?= $url ?>assets/js/cadastros/forma-de-pagamento/add.js"></script>