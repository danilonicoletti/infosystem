...
var KTNotaEdit = (function () {
            ...
            if (validator) {
                validator.validate().then(function (status) {
                    if (status == 'Valid') {
                        ...
                        //Form data
                        var form_data = $('#nota_edit_form').serializeArray();
    ...
    return {
        // public functions
        init: function () {
            _wizardEl = KTUtil.getById('nota_edit');
            _formEl = KTUtil.getById('nota_edit_form');
